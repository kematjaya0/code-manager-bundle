 ...
 */
class getTest_PrivateServicesLocatorService extends Kematjaya_CodeManagerBundle_Test_AppKernelTestTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'Kematjaya\\CodeManager\\Builder\\CodeBuilderInterface' => ['services', 'kmj.code_builder', 'getKmj_CodeBuilderService', true],
            'Kematjaya\\CodeManager\\Manager\\CodeLibraryLogManagerInterface' => ['services', 'kmj.code_log_manager', 'getKmj_CodeLogManagerService', true],
            'Kematjaya\\CodeManager\\Manager\\CodeManagerInterface' => ['services', 'kmj.code_manager', 'getKmj_CodeManagerService', true],
            'Kematjaya\\CodeManager\\Repository\\CodeLibraryLogRepositoryInterface' => ['privates', 'Kematjaya\\CodeManager\\Repository\\CodeLibraryLogRepositoryInterface', 'getCodeLibraryLogRepositoryInterfaceService', true],
            'Kematjaya\\CodeManager\\Repository\\CodeLibraryRepositoryInterface' => ['privates', 'Kematjaya\\CodeManager\\Repository\\CodeLibraryRepositoryInterface', 'getCodeLibraryRepositoryInterfaceService', true],
            ...
            'Kematjaya\\CodeManager\\Repository\\CodeLibraryLogRepositoryInterface' => '?',
            'Kematjaya\\CodeManager\\Repository\\CodeLibraryRepositoryInterface' => '?',
