 ...
 */
class Kematjaya_CodeManagerBundle_Test_AppKernelTestTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'kmj.code_builder' => 'getKmj_CodeBuilderService',
            'kmj.code_log_manager' => 'getKmj_CodeLogManagerService',
            'kmj.code_manager' => 'getKmj_CodeManagerService',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Kematjaya_CodeManagerBundle_Test_AppKernelTestTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                'CodeManagerBundle' => 'Kematjaya\\CodeManagerBundle\\CodeManagerBundle',
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
            ],
            'kernel.bundles_metadata' => [
                'CodeManagerBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/src'),
                    'namespace' => 'Kematjaya\\CodeManagerBundle',
                ],
                'FrameworkBundle' => [
            ...
            'kernel.container_class' => 'Kematjaya_CodeManagerBundle_Test_AppKernelTestTestDebugContainer',
